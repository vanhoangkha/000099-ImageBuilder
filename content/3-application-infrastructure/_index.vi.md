...
- [pre : " <b> 2. </b> "](#pre---b-2-b-)
    ...
    - [AWS CLI](#aws-cli)
    - [Xác Minh CloudFormation Stack Output](#xác-minh-cloudformation-stack-output)
...
![cloudformation-cli-describe-stack](/images/3-cloudformation-cli-describe-stack.png?width=90pc)
