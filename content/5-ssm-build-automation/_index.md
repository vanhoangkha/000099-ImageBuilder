---
title : "Build Automation with SSM"
date : "`r Sys.Date()`"
weight : 5
chapter : false
pre : " <b> 5. </b> "
...
**Deploy Build Automation with SSM**
...
- [AWS CLI](#aws-cli)
- [Preparing Automation Document](#preparing-automation-document)
- [Preparing Monitoring Script](#preparing-monitoring-script)
- [Execute Automation Document](#execute-automation-document)
- [Review AMI ID](#review-ami-id)
...
![cloudformation-create-stack](/images/5-cloudformation-create-stack.png?width=90pc)
